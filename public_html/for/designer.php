...
<head>
    ...
    <!-- Custom CSS -->
    <link rel="stylesheet" href="css/designer_creative.css" type="text/css">
</head>
...
<body>
        ...
        <div class="header-content">
            <div class="header-content-inner">
                ...
                <div class="backdropText">
                    ...
                    <h1>Design</h1>
                    <hr>
                    <p>Share your design choices, your color choices, your compositon and let the world vote.</p>
                </div>
    ...
    <section class="bg-primary" id="about">
        ...
        <div class="container">
            <h2 class="section-heading">Upload Your Design Choices.<br> Recieve Votes.<br> Find Motivation.</h2>
                                                                
            <hr class="light">
                                
            <p class="text-faded">Upload any design choice you make and receive input! Whether it's your color pallette, your composition choice, or a final-design comparison; you can get a yes/no response, or, upload two images and have the world compare!
            </p>
