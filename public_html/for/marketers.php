...
<head>
    ...
    <!-- Custom CSS -->
    <link rel="stylesheet" href="css/marketers_creative.css" type="text/css">
</head>
...
<body>
        ...
        <div class="header-content">
            <div class="header-content-inner">
                ...
                <div class="backdropText">
                    <h1>The World</h1><br>
                    <h1>Will Help You</h1><br>
                    <h1>Choose</h1>
                    <hr>
                    <p>Share your marketing choices, your promotional decisions, your media, and let the world vote.</p>
                </div>
    ...
    <section class="bg-primary" id="about">
        ...
        <div class="container">
            <h2 class="section-heading">Upload Your Decisions.<br> Recieve Votes.<br> Find Clarity.</h2>
                                                                
            <hr class="light">
                                
            <p class="text-faded">Upload any choice your faced with and receive input! Whether it's the color palette of your promotion, the wording choice, a final product comparison; you can get a yes/no response, or, upload two images and have the world compare!
            </p>
    ...
    <section class="bg-thirdly" id="subscribe">
        <div class="container">
            <h2 class="section-heading">Cue Count's a Free Tool & is Launching This Year. Sign Up and be a Part of it!</h2>
            
            <a href="#subscribe"></a>
            
            <p class="text-faded">The online place to be a human being is launching this year;<br> you should be one of the first to experience it!
            </p>
