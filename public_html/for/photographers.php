...
<head>
    ...
    <!-- Custom CSS -->
    <link rel="stylesheet" href="css/photographers_creative.css" type="text/css">
</head>
...
<body>
        ...
        <div class="header-content">
            <div class="header-content-inner">
                ...
                <div class="backdropText">
                    ...
                    <h1>Choose Photos</h1>
                    <hr>
                    <p>Share your photography choices, your color schemes, your lighting choice, and let the world vote.</p>
                </div>
    ...
    <section class="bg-primary" id="about">
        ...
        <div class="container">
            <h2 class="section-heading">Upload Your Creative Choices.<br> Recieve Votes.<br> Find Motivation and Clarity.</h2>
                                                                
            <hr class="light">
                                
            <p class="text-faded">Upload any decision your faced with and receive simple, clear input! You can get a yes/no response, or, upload two images and have the world compare!
            </p>
