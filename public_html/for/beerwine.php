...
<head>
    ...
    <!-- Custom CSS -->
    <link rel="stylesheet" href="css/beerwine_creative.css" type="text/css">
</head>
...
<body>
        ...
        <div class="header-content">
            <div class="header-content-inner">
                ...
                <div class="backdropText">
                    ...
                    <h1>Decide</h1>
                    <hr>
                    <p>Share your drink and beverage choices and let the world vote.</p>
                </div>
    ...
    <section class="bg-primary" id="about">
        ...
        <div class="container">
            <h2 class="section-heading">Upload Your Decisions.<br> Recieve Votes.<br> Find Motivation.</h2>
                                                                
            <hr class="light">
                                
            <p class="text-faded">You can get a yes/no response, or, upload two images and have the world vote! Whether for the sake of a good laugh, or for an informed choice.
            </p>
