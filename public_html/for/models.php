...
<head>
    ...
    <!-- Custom CSS -->
    <link rel="stylesheet" href="css/models_creative.css" type="text/css">
</head>
...
<body>
        ...
        <div class="header-content">
            <div class="header-content-inner">
                ...
                <div class="backdropText">
                	<h1>Your Art,</h1>
                    <h1>Your Choices</h1><br>
                    <h1>Let The World Vote</h1>
                    <hr>
                    <p>Share your modeling ventures, your outfit choices, compare photo choices and let the world vote.</p>
                </div>
    ...
    <section class="bg-primary" id="about">
        ...
        <div class="container">
            <h2 class="section-heading">Upload Your Choices.<br> Recieve Votes.<br> Find Clarity.</h2>
                                                                
            <hr class="light">
                                
            <p class="text-faded">Upload any choice your faced with and receive input! Whether it's the edit of your photoshot, the lighting choice, a make-up comparison; you can get a yes/no response, or, upload two images and have the world compare!
            </p>
    ...
    <section class="bg-thirdly" id="subscribe">
        <div class="container">
            <h2 class="section-heading">Cue Count's Free & Launching This Year. Sign Up and be a Part of it!</h2>
