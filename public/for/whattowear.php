...
<head>
    ...
    <!-- Custom CSS -->
    <link rel="stylesheet" href="css/whattowear_creative.css" type="text/css">
</head>
...
<body>
        ...
        <div class="header-content">
            <div class="header-content-inner">
                ...
                <div class="backdropText">
                    ...
                    <h1>Choose</h1>
                    <hr>
                    <p>Share your outfit choices, your color decisions and more; let the world vote.</p>
                </div>
    ...
    <section class="bg-primary" id="about">
        ...
        <div class="container">
            ...
            <p class="text-faded">Whether it's the color of your dress, the look, or a final outfit comparison; you can get a yes/no response, or, upload two images and have the world vote!
            </p>
