...
<head>
    ...
    <!-- Custom CSS -->
    <link rel="stylesheet" href="css/fineart_collect_creative.css" type="text/css">
</head>
...
<body>
        ...
        <div class="header-content">
            <div class="header-content-inner">
                ...
                <div class="backdropText">
                    ...
                    <h1>Choose Your Art</h1>
                    <hr>
                    <p>Share your art choices, your paintings, your display choices and let the world vote.</p>
                </div>
    ...
    <section class="bg-primary" id="about">
        ...
        <div class="container">
            ...
            <p class="text-faded">Upload any art choice you make and receive input! Whether it's for an art collection, or to sell; you can get a yes/no response, or, upload two images and have the world compare!
            </p>
