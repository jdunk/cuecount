...
<head>
    ...
    <!-- Custom CSS -->
    <link rel="stylesheet" href="css/night_outing_creative.css" type="text/css">
</head>
...
<body>
        ...
        <div class="header-content">
            <div class="header-content-inner">
                ...
                <div class="backdropText">
                    <h1>The World</h1><br>
                    <h1>Will Help You Choose</h1><br>
                    <h1>Your Outift</h1>
                    <hr>
                    <p>Share your outfit choices, share your desitination choices, and let the world vote.</p>
                </div>
    ...
    <section class="bg-primary" id="about">
        ...
        <div class="container">
            <h2 class="section-heading">Upload Your Choices.<br> Recieve Votes.<br> Find Perspective.</h2>
                                                                
            <hr class="light">
                                
            <p class="text-faded">Upload any decision and receive input! Whether it's the color of your dress, an outfit choice, or more; you can get a yes/no response, or, upload two images and have the world compare!
            </p>
