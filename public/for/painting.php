...
<head>
    ...
    <!-- Custom CSS -->
    <link rel="stylesheet" href="css/painting_creative.css" type="text/css">
</head>
...
<body>
        ...
        <div class="header-content">
            <div class="header-content-inner">
                ...
                <div class="backdropText">
                    ...
                    <h1>Paint</h1>
                    <hr>
                    <p>Share your painting choices, your color choices, your brush technique choices and let the world vote.</p>
                </div>
    ...
    <section class="bg-primary" id="about">
        ...
        <div class="container">
            ...
            <p class="text-faded">Upload any painting choice you make and receive input! Whether it's the colors your using, the canvas choice, a final product comparison; you can get a yes/no response, or, upload two images and have the world compare!
            </p>
